...
from gui.pdf_metin import birlesik_metin
...
class PdfSelectionMixin:
    ...
    def _normalize_pdf_text(text):
        """PDF metnindeki ayrik aksanlari harfleriyle birlestir.

        Govde `gui.pdf_metin`e tasindi: AYNI bilgiye arama yolu da muhtac ve
        orada yoktu (gerekce ve olcum o modulun basliginda). Ad burada
        korunuyor, cagiran ve testler bu adi kullaniyor.
        """
        return birlesik_metin(text)
